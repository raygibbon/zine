...
#
#  Target:
#    GNU C 4+ (CygWin, 64-bit)
#

#
# Set to 1 to link using static ../lib/x64/libwatt32-cygwin.a
#
STATIC_LIB = 0
...
CC      = gcc
CFLAGS  = -m64 -g -Wall -W -O2 -I../inc
CFLAGS  += -DWATT32 -I../inc

ifeq ($(STATIC_LIB),1)
  CFLAGS  += -DWATT32_STATIC
  LDFLAGS += -Wl,--enable-stdcall-fixup
  WATT_LIB = ../lib/x64/libwatt32-cygwin.a
else
  WATT_LIB = ../lib/x64/libwatt32-cygwin.dll.a
endif
